# My credits: https://github.com/Zane-Liao/assignment1-basics/blob/main/cs336_basics/tokenizer/tokenizer.py
import os
import re
import json
...
# credits: https://github.com/yulun-rayn/CS294-158/blob/main/deepul/models/text_encoder/simple.py
class WordEncoder:
